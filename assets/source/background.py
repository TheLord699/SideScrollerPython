...
class Background:
    ...
    def get_cached_image(self, image_path, width, height):
        ...
        if image_path and os.path.exists(image_path):
            ...
            self.image_cache[cache_key] = image_surface
        ...
        try:
            with open(background_file, "r") as file:
                ...
                for bg_id, bg_data in self.bg_settings.items():
                    ...
                    image_surface = self.get_cached_image(image_filename, width, height)
